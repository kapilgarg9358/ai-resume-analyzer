                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        {!confirmWipeAll ? (
                            ...
                            <div className="flex items-center gap-2 bg-red-50 border border-red-300 rounded-xl px-4 py-2">
                                <span className="text-sm text-red-700 font-medium">This action will permanently delete all records. Are you sure?</span>
                                <button onClick={handleDeleteAll} className="bg-red-500 text-white text-xs px-3 py-1 rounded-lg font-bold hover:bg-red-600">Yes, Delete All</button>
